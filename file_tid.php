                ...
                echo '
                    <div class="row jarak-form">
                        <ul class="collapsible white" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header white"><i class="material-icons md-prefix md-36">expand_more</i><span class="add">Tampilkan detail data MID</span></div>
                                        ...
                                        <div class="col m12 white">
                                            <table>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                    <td width="13%">Nama Toko Cabang</td>
                                                    <td width="1%">:</td>
                        ...
                        if(empty($row['file'])){
                            ...
                            if(in_array($eks, $ekstensi) == true){
                                echo '<img class="gbr" data-caption="'.date('d M Y', strtotime('now')).'" src="./upload/data_tid/'.$row['file'].'"/>';
                            } else {
                                                ...
                                                <div class="col s9 left">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-action">
                                                            <strong>Lihat file :</strong> <a class="blue-text" href="./upload/data_tid/'.$row['file'].'" target="_blank">'.$row['file'].'</a>
                                                        </div>
                                                    </div>
                                                </div>
