    ...
    if(empty($_SESSION['admin'])){
        ...
        <div class="container">
                    ...
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>';
                                ...
                                <td id="right"><strong>Tanggal Pendaftaran</strong></td>
                                <td id="left" colspan="2">: '.$d." ".$nm." ".$y.'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>Nama Penanggung Jawab</strong></td>
                                <td id="left" colspan="2">: '.$row['no_surat'].'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>Cabang Kota</strong></td>
                                <td id="left" colspan="2">: '.$row['asal_surat'].'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>Nama Toko Cabang</strong></td>
                                <td id="left" colspan="2">: '.$row['isi'].'</td>
                            </tr>
                            <tr>
                                <td id="right"><strong>Diterima Tanggal</strong></td>
                                <td id="left" style="border-right: none;">: '.$d." ".$nm." ".$y.'</td>
                                <td id="left"><strong>Nomor MID</strong> : '.$row['no_agenda'].'</td>
                            </tr>
                            <tr>
                            ...
                            <tr>';
                            $query3 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_tid ON tbl_disposisi.id_surat = tbl_tid.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
            ...
            <div id="lead">
                ...
                if(!empty($nip)){
                    echo '<p>Ahmad Maulana Yusuf '.$nip.'</p>';
                } else {
                    echo '<p>Ahmad Maulana Yusuf</p>';
                }
                echo '
            </div>
        </div>
