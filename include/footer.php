    ...
    <div class="footer-copyright blue-grey darken-1 white-text">
        <div class="container" id="footer">
            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        echo $data['nama']/* .' &nbsp;|&nbsp; <a class="white-text" href="http://masrud.com" target="_blank">By BANK BJB</a>'*/;
                    } else {
                        echo 'Bank BJB  &nbsp;|&nbsp; <a class="white-text" href="http://masrud.com" target="_blank">By BANK BJBa>';
                    }
                ?>
            </a>
            </span>
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> achmadmaulaana@gmail.com &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>  achmadmaulaana@gmail.com';
                    }
                }
                ?>
            </div>
