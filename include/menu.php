...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> BANK BJB</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/bjb.png"/>';
                            }
                            if(!empty($data['nama'])){
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
				    ...
				    <li>
                        <a class="collapsible-header"><i class="material-icons">repeat</i> Pendaftaran Mesin EDC</a>
                        <div class="collapsible-body">
                            <ul>
                              <li><a href="?page=dm">Data MID/ Daftar MID Baru</a></li>
							  <li><a href="?page=tdt">Data TID / Daftar TID Baru</a></li>
                            </ul>
                        </div>
                   </li>
                    ...
                    <li>
                        ...
                        <div class="collapsible-body">
                            <ul>
								...
								<li><a href="?page=gm">Data MID</a></li>
								<li><a href="?page=gt">Data TID</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
            </li>
            <li><a href="?page=ref"><i class="material-icons middle">class</i> Referensi Kode Kota</a></li>
            <li class="no-padding">
            <?php
                if($_SESSION['admin'] == 1){ ?>
                <ul class="collapsible collapsible-accordion">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">school</i> BANK BJB</a></li>
            <li><div class="grs"></></li>
            ...
            ?>
			  <li><a class="dropdown-button" href="#!" data-activates="transaksi">Pendaftaran Mesin EDC <i class="material-icons md-18">arrow_drop_down</i></a></li>
                <ul id='transaksi' class='dropdown-content'>
                    <li><a href="?page=dm">Data MID/ Daftar MID Baru</a></li>
                    <li><a href="?page=tdt">Data TID / Daftar TID Baru</a></li>
                </ul>
            ...
            <li><a href="?page=ref">Referensi Kode Kota</a></li>
            <?php
                if($_SESSION['admin'] == 1){ ?>
