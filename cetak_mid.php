                    ...
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td id="left" width="25"><strong>Kode Kota</strong> : '.$row['kode'].'</td>
                            </tr>
                            <tr>';
                            ...
                            <tr>
                                <td id="right"><strong>Nomor Handphone</strong></td>
                            ...
                            <tr>
                                <td id="right"><strong>Nama Toko</strong></td>
                            ...
                            <tr>';
                            $query3 = mysqli_query($config, "SELECT * FROM tbl_disposisi JOIN tbl_mid ON tbl_disposisi.id_surat = tbl_mid.id_surat WHERE tbl_disposisi.id_surat='$id_surat'");
