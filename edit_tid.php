<?php
    ...
    if(empty($_SESSION['admin'])){
                                            ...
                                            if($file != ""){
                                                ...
                                                if(in_array($eks, $ekstensi) == true){
                                                    if($ukuran < 2300000){
                                                        ...
                                                        $query = mysqli_query($config, "SELECT file FROM tbl_tid WHERE id_surat='$id_surat'");
                                                        ...
                                                        if(!empty($file)){
                                                            ...
                                                            $query = mysqli_query($config, "UPDATE tbl_tid SET no_agenda='$no_agenda',no_surat='$no_surat',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',file='$nfile',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
                                                ...
                                                $query = mysqli_query($config, "UPDATE tbl_tid SET no_agenda='$no_agenda',no_surat='$no_surat',asal_surat='$asal_surat',isi='$isi',kode='$nkode',indeks='$indeks',tgl_surat='$tgl_surat',keterangan='$keterangan',id_user='$id_user' WHERE id_surat='$id_surat'");
        ...
        $query = mysqli_query($config, "SELECT id_surat, no_agenda, no_surat, asal_surat, isi, kode, indeks, tgl_surat, file, keterangan, id_user FROM tbl_tid WHERE id_surat='$id_surat'");
        ...
        if($_SESSION['id_user'] != $id_user AND $_SESSION['id_user'] != 1){
            echo '<script language="javascript">
                    ...
                    window.location.href="./admin.php?page=tdt";
                  </script>';
        } else {?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Data TID Cabang Kota</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <!-- Form START -->
                <form class="col s12" method="POST" action="?page=tdt&act=edit" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Diambil dari data referensi kode klasifikasi">
                            ...
                            <input id="kode" type="text" class="validate" name="kode" value="<?php echo $kode ;?>" required>
                                ...
                                ?>
                            <label for="kode">Nomor TID</label>
                        </div>
                        <div class="input-field col s6">
                            ...
                            <input id="asal_surat" type="text" class="validate" name="asal_surat" value="<?php echo $asal_surat ;?>" required>
                                ...
                                ?>
                            <label for="asal_surat">Cabang Kota</label>
                        </div>
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="no_surat" type="text" class="validate" name="no_surat" value="<?php echo $no_surat ;?>" required>
                                ...
                                ?>
                            <label for="no_surat">Penanggung Jawab</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            ...
                            <textarea id="isi" class="materialize-textarea validate" name="isi" required><?php echo $isi ;?></textarea>
                                ...
                                ?>
                            <label for="isi">Nama Toko Cabang Kota</label>
                        </div>
                        <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            <div class="file-field input-field tooltipped" data-position="top" data-tooltip="Jika tidak ada file/scan gambar surat, biarkan kosong">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" value="<?php echo $file ;?>" placeholder="File Merupakan surat pengajuan dari pusat">
                                        <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col 6">
                            <a href="?page=tdt" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                        </div>
                    </div>
