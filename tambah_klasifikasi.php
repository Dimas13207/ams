                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="?page=ref&act=add" class="judul"><i class="material-icons">bookmark</i> Tambah Kode Kota</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12">
                                ...
                                <textarea id="uraian" class="materialize-textarea" name="uraian" required></textarea>
                                    ...
                                    ?>
                                <label for="uraian">Nama Provinsi</label>
                            </div>
                        </div>
                        <!-- Row in form END -->
                        <div class="row">
